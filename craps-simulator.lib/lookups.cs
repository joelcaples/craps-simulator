namespace craps_simulator {
    ...
    public class Lookups {
        ...
        public static ExpectedEdge TakeOddsSixOrEight => new(null, VI/V);
        public static ExpectedEdge TakeOddsFiveOrNine => new(null, III/II);
        public static ExpectedEdge TakeOddsFourOrTen => new(null, II/I);
        public static ExpectedEdge LayOddsSixOrEight => new(null, V / VI);
        public static ExpectedEdge LayOddsFiveOrNine => new(null, II / III);
        public static ExpectedEdge LayOddsFourOrTen => new(null, I / II);
        public static ExpectedEdge DoNotPlaceSixOrEight => new(null, IV / V);
        public static ExpectedEdge DoNotPlaceFiveOrNine => new(null, V / VIII);
        public static ExpectedEdge DoNotPlaceFourOrTen => new(null, V / XI);
