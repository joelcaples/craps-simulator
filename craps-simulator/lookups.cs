...
namespace craps_simulator {
    ...
    public class Lookups {
        ...
        //private const decimal IV = (decimal)4.0;
        public const decimal V = (decimal)5.0;
        public const decimal VI = (decimal)6.0;
        //private const decimal VII = (decimal)7.0;
        //private const decimal VIII = (decimal)8.0;
        ...
        public static ExpectedEdge PlaceFourOrTen => new(2 / 1, IX / V, 6.7, "");
        public static ExpectedEdge PlaceFiveOrNine => new(3 / 2, 7 / 5, 4, "");
        public static ExpectedEdge PlaceSixOrEight => new(6/5, 7/6, 1.52, "");

        public static ExpectedEdge Field => new (null, 1/1);
        public static ExpectedEdge FieldTwoOrTwelve => new (null, 2/1);
    }
}
